    ...
    <footer id="site-footer" className="relative">
      ...
      <div className="mx-auto flex max-w-5xl flex-col items-center justify-center gap-6 px-5 py-8 text-center sm:px-8">
        ...
        {pathname === "/" ? (
          ...
          >
            Back to home
            <svg viewBox="0 0 12 14" fill="none" className="h-3.5 w-3.5 transition-transform duration-300 group-hover:-translate-x-0.5" aria-hidden>
              <path d="M6 1v12m0 0l4.5-4.5M6 13L1.5 8.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="square" />
            </svg>
          </Link>
        )}
      </div>
